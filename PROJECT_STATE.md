...
## AW0.3 / AW0.301 — release freeze

- Текущая версия приложения и каталога: `AW0.301`.
- Базовый функциональный релиз: `AW0.3`.
- Journey 1.0: frozen.
- Стартовая контрольная точка: Git-тег `AW0.22`.
- `user.db Schema 1`, Contracts 1 и стабильные `catalog_id` сохраняются.
- Цикл открыт локально; commit, tag и публикация на GitHub ещё не выполнялись.

## AW0.22 — цикл завершён

- Версия приложения зафиксирована как `AW0.22`.
- Официальный каталог опубликован микропатчем `AW0.301`.
...
- Базовая контрольная точка: Git-тег `AW0.10`.
- Текущая версия официального каталога остаётся `AW0.0101`.
- Новые крупные изменения AW0.11 и следующие микропатчи каталога ведутся раздельно.
- Пользовательские данные, стабильные `catalog_id` и архив завершённых циклов не изменены при открытии версии.

## AW0.10 — завершён

- Завершённая версия приложения: `AW0.10`.
